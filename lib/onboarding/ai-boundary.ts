...
export async function getWebsiteGenerationInput(projectId: string) {
  ...
  return {
    ...
    websitePriorities: answers.websitePriorities,
    customerInsights: answers.customerInsights,
    customerConcerns: answers.customerConcerns,
    desiredCustomerReaction: answers.desiredCustomerReaction,
    ...
    brandFirstImpression: answers.brandFirstImpression,
    ...
    collaborationInvolvement: answers.collaborationInvolvement,
    feedbackCommunication: answers.feedbackCommunication,
    assets,
