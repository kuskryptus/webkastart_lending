...
export function coreProgress(answers: OnboardingAnswers): WorkspaceProgress {
  const values: Array<string | string[]> = [
    ...
    answers.goalImportance,
    answers.successCriteria,
    answers.websitePriorities,
    answers.customerInsights,
    answers.customerConcerns,
    answers.desiredCustomerReaction,
    ...
    answers.dislikes,
    answers.representativePhotoIds,
    answers.brandStory,
