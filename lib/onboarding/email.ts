  ...
  const groups: Array<{ title: string; rows: Array<[string, string | string[]]> }> = [
    ...
    },
    {
      ...
      rows: [
        ...
        ['Obavy zákazníka pred objednávkou', answers.customerConcerns],
        ['Želaná reakcia po návšteve webu', answers.desiredCustomerReaction],
    ...
    },
    {
      title: 'Vizuálny smer',
      rows: [
        ['Prvý dojem o firme po 5 sekundách', answers.brandFirstImpression],
        ['Slová reprezentujúce značku', answers.designPreferences],
        ['Iné slovo pre značku', answers.designOther],
        ...
        ['Čím značka nemá byť', answers.designDislikes],
        ['Iná neželaná vlastnosť značky', answers.dislikes],
