...
export function PhoneMockup({ alt, image, imageClassName, preload, tone = 'light' }: MockupProps) {
  return (
    <div data-device-mockup="phone" className="relative z-10 aspect-[9/19.5] w-[min(60vw,230px)] rounded-[2.45rem] bg-[#0b0b0b] p-1 shadow-[0_22px_56px_rgb(24_23_22_/_15%),0_4px_14px_rgb(24_23_22_/_8%)] ring-1 ring-black/20 min-[430px]:w-[min(56vw,245px)] sm:w-[240px] sm:rounded-[2.7rem] sm:p-[5px] lg:w-[250px]">
      ...
      <div className={`relative h-full overflow-hidden rounded-[2.18rem] ring-1 ring-black/30 sm:rounded-[2.4rem] ${tone === 'dark' ? 'bg-[#080808]' : 'bg-white'}`}>
        <Image
          ...
          fill
          preload={preload}
          sizes="(max-width: 429px) 60vw, (max-width: 639px) 56vw, (max-width: 1023px) 240px, 250px"
...
export function BrowserMockup({ alt, image, imageClassName, preload }: MockupProps) {
  return (
    <div data-device-mockup="browser" className="relative z-10 w-full max-w-[390px] overflow-hidden rounded-[1.15rem] bg-card shadow-[0_22px_60px_rgb(24_23_22_/_12%),0_4px_16px_rgb(24_23_22_/_7%)] ring-1 ring-black/10 sm:max-w-[560px] lg:max-w-[720px]">
...
export function LaptopMockup({ alt, image, imageClassName, preload }: MockupProps) {
  return (
    <div data-device-mockup="desktop" className="relative z-10 w-full max-w-[390px] pb-[5.5%] sm:max-w-[620px] lg:max-w-[760px]">
