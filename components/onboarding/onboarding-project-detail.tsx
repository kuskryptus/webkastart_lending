      ...
      <div className="mx-auto max-w-6xl px-5 pb-20 pt-8 sm:px-8 sm:pt-12">
        ...
        <PageSection id="core" title="Základný formulár" text="Pôvodný onboarding klienta. Existujúce otázky a odpovede zostávajú zachované.">
          ...
          <CoreStep number={2} title="Zákazníci a cieľ">
            ...
            <div className="sm:col-span-2"><Answer label="Obavy zákazníka pred objednávkou">{answers.customerConcerns}</Answer></div>
            <div className="sm:col-span-2"><Answer label="Želaná reakcia zákazníka po návšteve webu">{answers.desiredCustomerReaction}</Answer></div>
          ...
          <CoreStep number={4} title="Vizuálny smer">
            <div className="sm:col-span-2"><Answer label="Prvý dojem o firme po 5 sekundách">{answers.brandFirstImpression}</Answer></div><Answer label="Slová reprezentujúce značku"><SelectionList values={[...answers.designPreferences, ...(answers.designOther ? [answers.designOther] : [])]} /></Answer><Answer label="Farebné preferencie"><SelectionList values={[...answers.colorPreferences, ...(answers.colorPreferencesOther ? [answers.colorPreferencesOther] : [])]} /></Answer><Answer label="Čím značka nemá byť"><SelectionList values={[...answers.designDislikes, ...(answers.dislikes ? [answers.dislikes] : [])]} /></Answer>
